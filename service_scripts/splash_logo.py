...
disp = st7789.ST7789(spi, rotation=180, width=170, height=320, x_offset=35, # 1.9" ST7789
...
image = Image.open("/home/gadgetini/gadgetini_monitoring_tool/service_scripts/logo_vertical.jpg")
